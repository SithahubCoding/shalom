...
<section class="w-full bg-[#f8efff] relative">
    <div class="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 items-center pt-10 lg:px-10">
        <div class="col-span-1 px-2 lg:px-10 text-[#401457]" data-aos="fade-right" data-aos-duration="1000">
            <h2 class="text-[22px] xl:text-[30px]">{{ __('messages.what_we_do') }}</h2>
            <hr class="bg-[#401457] border-[#401457] border-b-0 mb-10">
            <h1 class="text-[30px] md:text-[40px] uppercase lg:leading-[55px]">{{ $hero->title[app()->getLocale()] }}</h1>
